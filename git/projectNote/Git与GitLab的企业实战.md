...
![1704960312687](image\image-5C1704960312687.png)

## 2. 基础操作

### 2.1 设置个人信息

![1704960580138](image\image-5C1704960580138.png)

### 2.2 创建新的Git仓库

![1704960497554](image\image-5C1704960497554.png)

### 2.3 提交不同版本

![1704960800309](image\image-5C1704960800309.png)

新创建文件1.txt，并写入信息。之后可以在GitGui上面进行提交。

![1704961275801](image\image-5C1704961275801.png)

多次提交的版本可以直接在History页面查看区别，不需要再使用reset命令。

![1704962382919](image\image-5C1704962382919.png)

## 3. 连接GitHub远程仓库

登录自己注册的账号

![1705040350413](image\image-5C1705040350413.png)

点击Publish可以将当前项目创建到GitHub上面。

![1705458108708](image\image-5C1705458108708.png)

之后修改本地文件，就可以先推送到本地git之后再远程同步到GitHub仓库中。

（1）选择对应的分支

![1705458651469](image\image-5C1705458651469.png)

（2）点击推送

![1705458678557](image\image-5C1705458678557.png)

（3）也可以先在GitHub上面创建远程仓库，之后再拉取到本地保持统一。

![1705459375393](image\image-5C1705459375393.png)

![1705459556035](image\image-5C1705459556035.png)
...
![1705472084800](image\image-5C1705472084800.png)
...
![1705472349179](image\image-5C1705472349179.png)
...
![1705473717653](image\image-5C1705473717653.png)
...
![1706088077244](image\image-5C1706088077244.png)

审查测试通过之后，完成合并

![1706087991195](image\image-5C1706087991195.png)
...
![1706146975271](image\image-5C1706146975271.png)
...
![1706151049392](image\image-5C1706151049392.png)
...
![1705898035403](image\image-5C1705898035403.png)
